...
public class PartyTest {
    ...
    public void testWarikan() {
        ...
        members.add(new Member(MemberName.of("Yoshimura"), SecretaryType.NonSecretary, paymentTypeLarge));
        members.add(new Member(MemberName.of("Motoyama"), SecretaryType.NonSecretary, paymentTypeLarge));
        members.add(new Member(MemberName.of("Ishibashi"), SecretaryType.NonSecretary, paymentTypeLarge));
        members.add(new Member(MemberName.of("Odori"), SecretaryType.NonSecretary, paymentTypeMidium));
        members.add(new Member(MemberName.of("Tokuyama"), SecretaryType.NonSecretary, paymentTypeSmall));
